...
import { View, Text, StyleSheet,TouchableOpacity,BackHandler,StatusBar} from 'react-native';
...
// create a component
const Accomodation = ({route,navigation}) => {
    ...
    return (
        <View style={styles.container}>
           <WebView
                source={{uri:"https://geospatialworldforum.org/accommodation.html"}}
            />
